...
export const g = {
  ...
  enemies: {
    ...
    small: {
      hitboxR: 1,
      health: 20,
      spriteRight: so(16, 0, 3, 3, 0, 0, 1, 1),
      spriteLeft: so(16, 0, 3, 3, 0, 0, 2, 1),
      spriteUp: so(20, 0, 2, 4, 1, -1, 2, 1),
      spriteDown: so(20, 0, 2, 4, 1, -1, 2, 0),
    ...
    medium: {
      hitboxR: 2,
      health: 65,
      spriteRight: so(24, 0, 4, 5, 0, -1, 1.5, 0.5),
      spriteLeft: so(24, 0, 4, 5, 0, -1, 1.5, 0.5),
      spriteUp: so(24, 0, 4, 5, 0, -1, 1.5, 0.5),
      spriteDown: so(24, 0, 4, 5, 0, -1, 1.5, 0.5),
    ...
    big: {
      hitboxR: 2,
      health: 130,
      spriteRight: so(16, 9, 5, 5, -1, -1, 0.5, 0.5),
      spriteLeft: so(22, 9, 5, 5, -1, -1, 1.5, 0.5),
      spriteUp: so(28, 8, 4, 6, 0, -1, 1.5, 1.5),
      spriteDown: so(33, 9, 4, 6, 0, -1, 1.5, 0.5),
